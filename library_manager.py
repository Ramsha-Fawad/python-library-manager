...
from stremlit_lottie import st_lottie
import requests
...
def add_book(title, author, publication_year, genre, read_status):
    book = {
        'title': title,
        'author': author,
        'publicatoin_year': publication_year,
        'genre': genre,
...
lottie_book = load_lottieur("https://assets9.lottieflies.com/temp/1f20_aKAfIn.json")
if lottie_book:
    with st.sidebar:
...
st.markdown("---")
st.markdown("Copyright @ 2025 Ramsha Fawad Personal Library Manager", unsafe_allow_html=True)
