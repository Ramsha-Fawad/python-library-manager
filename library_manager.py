    ...
    with st.form(key='add_book_form'):
        ...
        with col2:
            genre = st.selectbox("Genre", [
                ...
                "Mystery", "Romance", "Thriller", "Biography", "Technology", 
...
# Footer
st.markdown("---")
st.markdown("© 2025 Ramsha Fawad Personal Library Manager | Created with Love and Streamlit", unsafe_allow_html=True)
